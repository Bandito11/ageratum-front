                                        ...
                                        for (let i = index + 3; i < contents.length; i++) {
                                            ...
                                            if (contents[i] == '>') {
                                                for (let j = i + 1; j < contents.length; j++) {
                                                    ...
                                                    if (contents[j] == 'i' && contents[j + 1] == 'm' && contents[j + 2] == 'g') {
                                                        src = '';
            ...
            <div>
                <form onSubmit={e => this.onSubmit(e)} class="form-horizontal">
                    <div class="form-group col-10 col-mx-auto">
                        ...
                        <input class="form-input" type="text" id="date" value={this.date} placeholder="Domingo 1 de Enero de 2018" onInput={event => this.getValue({ type: 'date', event: event })} />
                        ...
                        <hr />
                        <textarea id="textarea" class="form-input" value={this.content} onInput={event => this.getValue({ type: 'textarea', event: event })}></textarea>
                    </div>
                </form>
                {this.getHTML()}
            </div>
