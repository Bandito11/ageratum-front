export interface IBlogContent{  alt: string; img:string; text: string;   type: string;   link: string; }
// interface IBlogData {   id: string;   author: string;   email: string;
// date: string;   title: string;   content: Array<Partial<IBlogContent>>; }
...
export function getImageSrc(link: string) : string {
  try {
